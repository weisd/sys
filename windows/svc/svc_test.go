...
import (
	...
	"github.com/weisd/sys/windows/svc"
	"github.com/weisd/sys/windows/svc/mgr"
)
...
func TestExample(t *testing.T) {
	...
	o, err := exec.Command("go", "build", "-o", exepath, "github.com/weisd/sys/windows/svc/example").CombinedOutput()
	if err != nil {
